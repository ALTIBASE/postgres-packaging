...
get_sources(){
    ...
    rm -f control rules
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/${PG_VERSION}/timescaledb/control
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/${PG_VERSION}/timescaledb/control.in
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/${PG_VERSION}/timescaledb/rules
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/${PG_VERSION}/timescaledb/percona-timescaledb.spec
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/${PG_VERSION}/timescaledb/timescaledb-cmake3-rhel7.patch
    cd ${WORKDIR}
    #

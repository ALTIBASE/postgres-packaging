...
get_sources(){
    ...
    mkdir debian
    cd debian/
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/13/pgadmin4/control
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/13/pgadmin4/rules
    chmod +x rules
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/13/pgadmin4/copyright
    echo 9 > compat
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/13/pgadmin4/percona-pgadmin4.spec
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/13/pgadmin4/pgadmin4-sphinx-theme.patch
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/13/pgadmin4/pgadmin4-python3-mod_wsgi.conf
    wget https://raw.githubusercontent.com/ALTIBASE/postgres-packaging/13/pgadmin4/pgadmin4-python3-mod_wsgi-exports.patch
    cd ${WORKDIR}
    #
